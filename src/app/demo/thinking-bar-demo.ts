  ...
  protected readonly api: ApiSection[] = [
    {
      ...
      props: [
        ...
        { name: 'stopLabel', type: 'string', default: "'Answer now'", description: 'Stop button label.' },
        { name: 'showStop', type: 'boolean', default: 'false', description: 'Render the stop button.' },
        { name: 'clickable', type: 'boolean', default: 'false', description: 'Render the label as a click target with chevron.' },
        { name: 'stopped', type: 'output<void>', description: 'Fires when the stop button is clicked.' },
        { name: 'clicked', type: 'output<void>', description: 'Fires when the bar is clicked (when clickable).' },
